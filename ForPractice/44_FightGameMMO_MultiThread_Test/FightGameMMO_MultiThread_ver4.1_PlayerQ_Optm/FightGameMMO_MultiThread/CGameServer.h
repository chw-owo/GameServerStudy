...
private:
	...
	inline void GetDataFromPacket(int threadNum);
	inline void LogicUpdate(int threadNum);

private:
	inline void CreatePlayer(__int64 sessionID, CPlayer* pPlayer);
	inline void SetPlayerDead(CPlayer* pPlayer);
...
private:
	// Handle System Job
	inline void Handle_ACCEPT(__int64 sessionID, CPlayer* pPlayer);
