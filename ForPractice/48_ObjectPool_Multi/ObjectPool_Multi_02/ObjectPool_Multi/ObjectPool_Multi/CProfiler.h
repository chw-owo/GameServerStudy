...
#define RESULT_PER_PROFILER 64
#define MINMAX_CNT 2
#define BUFFER_SIZE 256
#define OUTPUT_SIZE BUFFER_SIZE * RESULT_PER_PROFILER
...
private:
	DWORD _threadID;
	LARGE_INTEGER _freq;
	_PROFILE_RESULT _profileResults[RESULT_PER_PROFILER];
	int _IDSupplier = 0;
};
