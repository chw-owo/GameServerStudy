...
public:
	...
	//CTlsPool<StackNode>* _pStackPool;
...
public:
	...
	{
		// _pStackPool = new CTlsPool<StackNode>(dfSTACKNODE_CNT_DEF, dfSTACKNODE_BUCKET_SIZE, false);
...
template<typename T>
CTlsPool<typename CLockFreeStack<T>::StackNode>* CLockFreeStack<T>::_pStackPool 
	= new CTlsPool<CLockFreeStack<T>::StackNode>(dfSTACKNODE_CNT_DEF, dfSTACKNODE_BUCKET_SIZE, false);