...
public: // Debug
	...
	inline long GetRecvPostCnt()
	{
		long ret = InterlockedExchange(&_RecvPostCnt, 0);
		return ret;
	}
	inline long GetSendPostCnt()
	{
		long ret = InterlockedExchange(&_SendPostCnt, 0);
		return ret;
	}
	inline long GetReleaseCnt()
	{
		long ret = InterlockedExchange(&_ReleaseCnt, 0);
		return ret;
	}
	*/
