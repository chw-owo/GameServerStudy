...
protected:
	...
	inline long GetEmptySessionCount() { return _emptyIdx.GetUseSize(); }
...
public: // For Profilings
	long _Idx = -1;
	long _NetUpdates[2] = { 0, 0 };
	DWORD _netStarts[2] = { 0, 0 };
	DWORD _netSums[2] = { 0, 0 };

	long _SendPost[2] = { 0, 0 };
	long _SendComp[2] = { 0, 0 };
	long _RecvComp[2] = { 0, 0 };
	long _SessionNull[2] = { 0, 0 };
	long _SessionDead[2] = { 0, 0 };
};
#endif