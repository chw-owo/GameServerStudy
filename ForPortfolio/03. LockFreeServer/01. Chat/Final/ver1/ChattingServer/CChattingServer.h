...
private:
	...
	inline void HandleRecv(unsigned __int64 sessionID, CRecvNetPacket* packet);
...
private:
	inline void ReqSendUnicast(CNetPacket* packet, __int64 sessionID);
	inline void ReqSendAroundSector(CNetPacket* packet, CSector* centerSector, CPlayer* pExpPlayer = nullptr);
