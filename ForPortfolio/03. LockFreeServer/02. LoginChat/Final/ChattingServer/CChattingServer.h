...
private:
	inline void SetSCNetSendPacket_RES_LOGIN(CNetSendPacket* packet, BYTE status, __int64 accountNo);
	inline void SetSCNetSendPacket_RES_SECTOR_MOVE(CNetSendPacket* packet, __int64 accountNo, WORD sectorX, WORD sectorY);
	inline void SetSCNetSendPacket_RES_MESSAGE(CNetSendPacket* packet, __int64 accountNo, wchar_t* ID, wchar_t* nickname, WORD messageLen, wchar_t* message);
